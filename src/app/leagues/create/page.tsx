  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center">
      <div className="w-full max-w-sm animate-fade-up">
        <p className="font-mono text-f1red text-xs tracking-widest uppercase mb-1">New league</p>
        <h1 className="font-display font-black text-4xl uppercase tracking-tight mb-2">Create League</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="font-mono text-xs text-f1muted uppercase tracking-wide">League Name</label>
            <input
              type="text"
              value={name}
